...
# 데이터 읽어오기
test_x = pd.read_csv(r'C:\Team3\ryu\test_x.csv')
test_y = pd.read_csv(r'C:\Team3\ryu\test_y.csv')
train_x = pd.read_csv(r'C:\Team3\ryu\train_x.csv')
train_y = pd.read_csv(r'C:\Team3\ryu\train_y.csv')
...
test_x_values = test_x.drop(['time','round'], axis=1)
...
# 사용한 트레인 저장
test_x.to_csv(os.path.join(model_directory, "test_x.csv"), mode='w', index=False)
test_y.to_csv(os.path.join(model_directory, "test_y.csv"), mode='w', index=False)
