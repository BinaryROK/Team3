...
# 라운드1의 모델5개의 예측값, 실제발전량 으로 모델5개중 가장 오차가 적은 예측값 가져오기
...
# round1의 모델별예측량, 실제발전량, 모델별 오차, 최적모델
filtered_df_1 = pivoted_df[pivoted_df['round'] == 1]
...
filtered_df_1.to_csv("C:\Team3\Data\OIBC2023_data\gen_pred_round1.csv", mode='w', index=False)
pred_round.to_csv("C:\Team3\Data\OIBC2023_data\optical_gen_round1.csv", mode='w', index=False)
